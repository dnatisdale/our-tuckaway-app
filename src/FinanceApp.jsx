...
export default function FinanceApp() {
  ...
  const totalCCUSD = creditCards.reduce(
    (acc, cc) =>
      cc.isHidden ? acc : acc + (Number(cc.bal.replace(/,/g, "")) || 0),
    0,
  );
  const totalCashUSD = savingsAccounts.reduce(
    (acc, cash) =>
      cash.isHidden ? acc : acc + (Number(cash.bal.replace(/,/g, "")) || 0),
    0,
  );
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ position: "relative" }} className="print-hide">
              ...
              >
                Our TuckAway <br />
                <span style={{ color: "#ED1C24", fontSize: "18px" }}>
                  {currentMonthDisplay}
                </span>
              </h1>
              <input
        ...
        >
          ...
          >
            ...
            <span
              style={{ fontWeight: "900", color: "#000", fontSize: "20px" }}
            >
              {fmtCur(totalCashUSD)}
            </span>
          </div>
        ...
        >
          ...
          <div
            style={{ fontSize: "22px", fontWeight: "900", color: "#ED1C24" }}
          >
...
const DaysIndicator = ({ days, type }) => {
  if (days === null)
    return <div style={{ fontSize: "10px", height: "12px" }}></div>;
  ...
  if (days === 0) {
    ...
    content = (
      <>
        In <span style={{ color: "red" }}>{days}</span> d
      </>
    );
  }
